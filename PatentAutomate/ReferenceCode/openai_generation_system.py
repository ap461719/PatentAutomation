...
INIT_INSTRUCTION = '''Generate a technical description focusing on molecular mechanisms, structural design rationale, and technical implementation. Use varied sentence openings and avoid repetitive language patterns:

{claim}'''

CONTINUE_INSTRUCTION = '''Continue with additional technical details using completely different sentence structures and terminology. Focus on new technical aspects without repeating previous explanations:
...
def generate_full_desc(claims):
    ...
    # Update the EMBODIMENT_PROMPT_IN_CONTEXT to include the new guidelines
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate patent descriptions using OpenAI')
    ...
    try:
        print(f"Generating description using {args.method} method...")
